...
main = do
  xmonad $ defaultConfig
    ...
    , ((mod4Mask                ,xK_Down    ),spawn "pactl set-sink-mute 0 false ; pactl set-sink-volume 0 -5%")
    , ((mod4Mask                ,xK_Up      ),spawn "pactl set-sink-mute 0 false ; pactl set-sink-volume 0 +5%")
