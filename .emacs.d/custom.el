(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (auto-complete exwm flymake-hlint haskell-mode xelb wrap-region web-mode js2-mode iy-go-to-char flycheck expand-region)))
 '(show-paren-mode t))
(custom-set-faces
 ...
 '(web-mode-html-tag-face ((t (:foreground "dim gray")))))
